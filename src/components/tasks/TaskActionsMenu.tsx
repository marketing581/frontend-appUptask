...
/** Acciones secundarias de un pendiente: ocultar, eliminar. Mover a un día ya
 *  no vive aquí —se arrastra, y tener las dos formas era redundante—.
 *
...
export default function TaskActionsMenu({
    taskName, canEdit, canHide, isPrivate,
    onToggleHide, onRequestDelete
}: Props) {
        ...
        <>
            ...
            {open && position && createPortal(
                ...
                >
                    ...
                    {canHide && canEdit && <div className="my-1 border-t border-line" />}
                    {canEdit && (
                        <button
                            type="button"
                            role="menuitem"
